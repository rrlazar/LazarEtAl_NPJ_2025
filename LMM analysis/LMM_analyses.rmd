...
tab_model(KSS_arvo_sparse, p.threshold =0.05,  show.se=T, show.stat=T, show.df = T, 
          show.aic = T#, pred.labels = pred_labels_time)
)
...
tab_model(PVT_mean_1divRT_arvo_sparse, p.threshold =0.05,  show.se=T, show.stat=T, show.df = T, show.aic = T#, pred.labels = pred_labels_time)
)
...
tab_model(DPG_eve_sparse, p.threshold =0.05,  show.se=T, show.stat=T, show.df = T, 
          show.aic = T#, pred.labels = pred_labels_time)
)
```
