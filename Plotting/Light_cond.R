...
ggsave(spectra_plot_log, file = "./Plotting/Output/spectra_plot_log.svg", 
...
ggsave(spectra_plot, file = "./Plotting/Output/spectra_plot.svg", 
       width = 200, height = 110, units = "mm", dpi = 1000)
...
ggsave(BB_plot, file = "./Plotting/Output/BB_plot.svg", 
       width = 200, height = 110, units = "mm", dpi = 1000)
